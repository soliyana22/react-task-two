            ...
            <div className="landing-mission-points">
              <div className="landing-mission-point">
                ...
                <p className="landing-mission-text">
                 Lorem ipsum dolor sit amet,<br/>consectetur adipiscing elit. Sed efficitur,<br/> lectus et facilisis placerat.
              ...
              <div className="landing-mission-point">
                ...
                <p className="landing-mission-text">
                  LLorem ipsum dolor sit amet, consectetur<br/> adipiscing elit. Sed efficitur, lectus et<br/> facilisis placerat, magna mauris porttitor <br/>tortor, a auctor est felis ut nisl. 
                </p>
              </div>
            </div>
          </div>
